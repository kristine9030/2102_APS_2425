...
public class CustomerDashboard extends javax.swing.JFrame {
    ...
    private String username; // Field to store the logged-in user's username
    private JLabel usernameLabel; // Label to display the username
    
    public CustomerDashboard() {
        initComponents();
        // Initialize the username label
        usernameLabel = new JLabel();
        usernameLabel.setBounds(10, 10, 200, 30); // Set position and size
        jPanel1.add(usernameLabel); // Add to the main panel or relevant panel
    }
    ...
    private void initComponents() {
        ...
        CustomerButton.setText("Dashboard");
    ...
    public void setUser(String uname) {
        this.username = uname;
        usernameLabel.setText("Welcome, " + username); // Set text to display the username
    }
