...
public class Login extends javax.swing.JFrame {
    ...
    private void LoginBtnAction1Performed(java.awt.event.ActionEvent evt) {                                         
    // System.out.println("Sign up btn clicked");
    Home hm =new Home();
    hm.setVisible(true);
    
    String Email, Password, query, uname = null, passDb = null;
    ...
    try{
        ...
        if("".equals(email.getText())){
            ...
            while(rs.next()){
                ...
                uname = rs.getString("username"); // Using "uname" instead of "fname"
                notFound = 1;
            }

            if(notFound == 1 && Password.equals(passDb)){
                Home HomeFrame = new Home();
                HomeFrame.setUser(uname); // Using "uname" instead of "fname"
