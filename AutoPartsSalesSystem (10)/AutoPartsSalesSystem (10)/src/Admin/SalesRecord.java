...
public class SalesRecord extends javax.swing.JFrame {
    ...
    public SalesRecord(int adminID) {
    ...
    private void initComponents() {
        ...
        jPanel7.add(AdminBtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(950, 560, 90, -1));
        ...
        jPanel7.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 70, 690, 410));

        panelLineChart.setLayout(new java.awt.BorderLayout());
        jPanel7.add(panelLineChart, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 120, 300, 360));

        jLabel5.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel5.setText("TOTAL SALES");
        jPanel7.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 500, -1, -1));
        ...
        jPanel7.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 490, 160, 40));
    ...
    private void AdminBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AdminBtnActionPerformed
     ...
     private void DisplayItems(){
        ...
        ResultSet Rs = St.executeQuery(
            "SELECT paymentID, orderID, productName, price, quantity, subtotal, dateTimestamp FROM payment"
        );
        
        // Use DbUtils to set the ResultSet data to the salesTable model
        salesTable.setModel(DbUtils.resultSetToTableModel(Rs));

        // Optionally adjust column widths if needed (e.g., productName and dateTimestamp)
        TableColumn productColumn = salesTable.getColumn("productName");
        if (productColumn != null) {
            productColumn.setMinWidth(150);
            productColumn.setPreferredWidth(200);
        }
        
        TableColumn dateColumn = salesTable.getColumn("dateTimestamp");
        if (dateColumn != null) {
        ...
        JOptionPane.showMessageDialog(this, "Error displaying payments: " + e.getMessage());
    }
     }
